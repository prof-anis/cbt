...
<html lang="en">
    <head>
        ...
        <link href="{{asset('adminpage/css/pricing.css')}}" rel="stylesheet"/>
        <!-- <link href="{{asset('adminpage/css/styles3.css')}}" rel="stylesheet"/> -->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid bg">
                        ...
                        <div class=" {{(isset($_SESSION['package_status']))? 'alert alert-info title' : ''}}">{{(isset($_SESSION['package_status']))? $_SESSION['package_status'] : ''}}</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="pricingTable green">
                                            ...
                                            <div class="pricingTable-signup">
                                                <a href="{{route('pay', ['price'=>7500000])}}">go premium</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <div class="pricingTable yellow">
                                            ...
                                            <div class="pricingTable-signup">
                                                <a href="{{route('pay', ['price'=>12500000])}}">go premium</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
