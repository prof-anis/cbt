...
<html>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="<?php echo route('home'); ?>">Student Portal</a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button
            ><!-- Navbar Search-->
...
<ul class="nav nav-pills justify-content-end">
    ...
    <li class="nav-item">
    <a class="nav-link active" href="<?php echo route('student_profile_edit', ['id'=>$user_id]); ?>">Edit Profile</a>
    </li>
